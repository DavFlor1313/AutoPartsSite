<%-- 
    ...
    Created on : Nov 12, 2018, 3:25:11 PM
--%>
...
<div class="tab-pane" id="orders" role="tabpanel">
                    <div class="panel panel-info">
                        <div class="panel-heading text-center"><h3>Order Lookup</h3></div>
                        <div class="panel-body">   
                            <c:if test="${orders != null}">
                                <c:forEach items="${requestScope.orders}" var="order">
                                    <div class="panel panel-primary">
                                        <div class="panel-heading">
                                            <h3 class="panel-title">Order #${order.getID()} placed on ${order.getDate()} | <span class="font-weight-bold"> Order ID: ${order.getEncID()}</span></h3>
                                        </div>
                                        <div class="panel-body">
                                            <c:if test="${admin}">
